...
pub fn default_config(addr: String, username: String, dictionary: String, key: String, show_chrome: bool) {
    brute_website(addr, String::from("input[type=text]"), String::from("input[type=password]"), String::from("input[type=submit]"), username, dictionary, key, show_chrome);
}
...
pub fn config_field_email(addr: String, username: String, dictionary: String, key: String,show_chrome: bool) {
    brute_website(addr, String::from("input[type=email]"), String::from("input[type=password]"), String::from("input[type=submit]"), username, dictionary, key, show_chrome);
}
...
pub fn config_field_button(addr: String, username: String, dictionary: String, key: String,show_chrome: bool) {
    brute_website(addr, String::from("input[type=text]"), String::from("input[type=password]"), String::from("button"), username, dictionary, key, show_chrome);
}
...
pub fn config_field_email_button(addr: String, username: String, dictionary: String, key: String,show_chrome: bool) {
    brute_website(addr, String::from("input[type=email]"), String::from("input[type=password]"), String::from("button"), username, dictionary, key, show_chrome);
}
...
pub fn config_button(addr: String, username: String, dictionary: String, key: String, button: String,show_chrome: bool) {
    brute_website(addr, String::from("input[type=text]"), String::from("input[type=password]"), button, username, dictionary, key, show_chrome);
}
...
pub fn config_email_button(addr: String, username: String, dictionary: String, key: String, button: String,show_chrome: bool) {
    brute_website(addr, String::from("input[type=email]"), String::from("input[type=password]"), button, username, dictionary, key, show_chrome);
}